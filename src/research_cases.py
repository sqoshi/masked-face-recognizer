...
class AnalysisConfig:
    ...
    @staticmethod
    def create_modifications(modifications: Union[tuple, DatasetModifications]) -> DatasetModifications:
    ...
    def values(self):
        return self.dataset, self.split_ratio, self.modifications.test, self.modifications.train, self.personal_images_quantity
...
configs = [
    ...
    AnalysisConfig(celeba, 0.8, 32, None, None),
